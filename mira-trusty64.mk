...
APT_INSTALL:=libboost-all-dev \
	libncurses5-dev libogre-1.8-dev libqwt5-qt4-dev libsqlite3-dev libssl-dev libxml2-dev \
	libxrandr-dev pyqt4-dev-tools qt4-dev-tools ros-indigo-opencv3  subversion libsvn-dev
...
INSTALL_COMMAND=bash ./mira-installer-binary.sh ubuntu-1404lts-x64 $(GLOBAL_ROOT)
